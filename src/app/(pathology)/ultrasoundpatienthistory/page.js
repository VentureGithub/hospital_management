...
export function UltrasoundPatientHistory() {
    return (
        <LayoutForm>
            <Heading headingText="Ultrasound Patient History" />
            <UltrasoundPatientHistoryform />
        </LayoutForm>
    );
}

const UltrasoundPatientHistoryform = () => {
            ...
            try {
                ...
                if (isEdit) {
                    ...
                    response = await apiClient.post(
                        `ultraSoundHistory/saveUltraSoundreport`,
                        values
                    );
                }
            ...
            <div className='p-7'>
                <form className='lg:w-[60%] md:w-[100%] sm:w-[100%]' onSubmit={formik.handleSubmit}>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center mb-4">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center mb-4">
                            <div className="w-full sm:w-[20%] mb-2 sm:mb-0">
                                <label className="block font-semibold">OPD/IPD No </label>
                            </div>
                            <div className="w-full sm:w-[80%]">
                                <input
                                    type="test"
...
export default withAuth(UltrasoundPatientHistory, ['SUPERADMIN', 'ADMIN','DOCTOR'])

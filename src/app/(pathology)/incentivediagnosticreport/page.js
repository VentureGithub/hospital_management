...
export function IncentiveDiagnosticReport() {
    return (
        <LayoutForm>
            <Heading headingText="Incentive Diagnostic Report" />
            <IncentiveDiagnosticReportform />
        </LayoutForm>
    );
}

const IncentiveDiagnosticReportform = () => {
...
export default withAuth(IncentiveDiagnosticReport, ['SUPERADMIN', 'ADMIN','DOCTOR'])

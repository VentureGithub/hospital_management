...
import { PurchaseReport } from "../purchasereport/page";


export function SaleReturnReport() {
    return (
        <LayoutForm>
            <Heading headingText="Sale Return Report" />
...
export default withAuth(SaleReturnReport, ['DOCTOR', 'ADMIN', 'SUPERADMIN'])
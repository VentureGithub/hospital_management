...
//     return (
//         <LayoutForm>
//             <Icon message=": This page manages the HSN (Harmonized System of Nomenclature) and SAC (Services Accounting Code) details, including the HSN/SAC number and its short name, to streamline tax categorization and reporting for hospital inventory and services." />
//             <SaltMasterform />
//         </LayoutForm>
//     );
// }
...
//                                 onChange={handleChange}
//                                 value={inputs.hsnShortNameString}
//                             />
//                         </div>
//                     </div>
...
//                                                 </button>
//                                             </td>
//                                             {/* <td className="px-4 py-3 border border-gray-200">{transaction.hsnIdLong}</td> */}
//                                             <td className="px-4 py-3 border border-gray-200">{transaction.hsnCodeString}</td>
//                                             <td className="px-4 py-3 border border-gray-200">{transaction.hsnShortNameString}</td>

...
//     return (
//         <LayoutForm>
//             <Icon message="This page manages the details of various salts used in pharmaceutical products, allowing you to define and categorize them by their names for easy reference and inventory management." />
//             <SaltMasterform />
//         </LayoutForm>
//     );
// }
...
//                         <div >
//                             <label className="block font-semibold text-sm">Salt Name</label>
//                             <input type="text"
...
//                         </div>
//                         {/* <div>
//                             <label className="block text-gray-700">Salt Name </label>
//                             <input type="text"
...
//                                     {/* <th className="px-4 py-2 border border-gray-200 text-sky-500">Salt Id</th> */}
...
//                                                 </button>
//                                             </td>
//                                             {/* <td className="px-4 py-3 border border-gray-200">{transaction.saltmasterIdLong}</td> */}

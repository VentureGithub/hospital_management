...
const SaleReportform = () => {
    ...
    const handlePrint = async (e) => {
        ...
        try {
            const response = await apiClient.get(`itemSale/generateSaleInvoice`, {
                params: { saleCode },
                responseType: 'blob',
            });
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-2 m-2">
                        <div className="flex flex-col sm:flex-row sm:items-center mb-4">
                            <div className="w-full sm:w-[20%] mb-2 sm:mb-0">
                                <label className="block font-semibold">Sale Code </label>
                            </div>
...
export default withAuth(SaleReport, ['SUPERADMIN', 'ADMIN', 'DOCTOR']);

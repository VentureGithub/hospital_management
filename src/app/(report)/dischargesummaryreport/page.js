...
const Dischargesummaryform = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                const response = await apiClient.get('dischargePatient/bill/discharge-history-report', {
    ...
    return (
        <div className="p-4 bg-gray-50 mt-6 ml-6 rounded-md shadow-xl">
            <Heading headingText="Discharge Summary Report" />
            <div className='py-4'>
...
export default withAuth(Dischargesummary, ['SUPERADMIN', 'ADMIN', 'DOCTOR']);

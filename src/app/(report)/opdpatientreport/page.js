...
//         if (!selectedDr || !selectedDept) {
//             alert("Please select both a doctor and a department.");
//             return;
//         }
...
//             <div className='py-4'>
//                     <form className='lg:w-[50%] md:w-[80%] sm:w-[100%]' onSubmit={handleSubmit}>
//                         <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-4">
//                             <div className="mb-5">
//                                 <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Dr Id</label>
//                                 <select onChange={(e) => setSelectedDr(e.target.value)} className="w-full px-4 py-2 text-sm border rounded-lg focus:outline-none">
...
//                             </div>
//                             <div className="mb-5">
//                                 <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white ">Department Id</label>
//                                 <select onChange={(e) => setSelectedDept(e.target.value)} className="w-full px-4 text-sm py-2 border rounded-lg focus:outline-none">
